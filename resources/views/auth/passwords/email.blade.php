            ...
            <div class="container">
                ...
                <div id="navbar-collapse-1" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav mainNav">
                        <!-- Classic dropdown -->
                        <li class="scroll"><a class="scroll" data-href="#main" href="#main">الرئيسية</a></li>
...
<!--*********************************************** navbar end ******************************************************  -->
<!--********************************************************** بداية محتوى الصفحة *********************************************** -->
<section class="home mt-5 mb-5 " id="" style="margin-top:105px;">
    <div class="container">
        <div class="  row justify-content-center">
            <h2 style="color:white;padding:18px;font-size:40px">استرجاع كلمة المرور </h2>
        </div>
    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input name="recover-submit" class="btn btn-lg  btn-block"
                                               value="استرجاع كلمة المرور" type="reset"
