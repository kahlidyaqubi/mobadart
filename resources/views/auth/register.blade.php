                    ...
                    <form method="POST" action="{{ route('register') }}">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="city_id" type="text" class="form-control{{ $errors->has('city_id') ? ' is-invalid' : '' }}" name="city_id" value="{{ old('city_id') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            <label for="brth_day" class="col-md-4 col-form-label text-md-right">{{ __('Berth Day') }}</label>

                            <div class="col-md-6">
                                <input id="brth_day" type="date" class="form-control{{ $errors->has('brth_day') ? ' is-invalid' : '' }}" name="brth_day" value="{{ old('brth_day') }}" required autofocus>

                                @if ($errors->has('brth_day'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('brth_day') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
