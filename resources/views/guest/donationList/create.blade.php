                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group form-group">
                                ...
                                <input readonly type="number" class="form-control" value="{{$site_bank_account}}"
                                       placeholder=" 7653417865">
                            </div>
                            <!-- المبادرة -->
                            <div class="input-group form-group">
                                <div class="input-group-prepend">
                                ...
                                <div class="form-control">
                                    <span class="input-group-text">{{\App\Initiative::find(request('initiative_id'))->title}}</span>
                                </div>
                                    <input type="hidden" name="initiative_id" value="{{\App\Initiative::find(request('initiative_id'))->id}}">
                               @else
                            ...
                            <div class="input-group form-group">
                                ...
                                <input required type="number" name="bank_account" value="{{old('bank_account')}}"
                                       class="form-control"
                            ...
                            <div class="input-group form-group">
                                ...
                                <input required type="text" name="financier_name" value="{{old('financier_name')}}"
                                       class="form-control" placeholder="أدخل اسمك كاملاً">
                            </div>
                            <!--  المبلغ-->
                            <div class="input-group form-group">
                                <div class="input-group-prepend">
                                ...
                                <input required type="number" name="amount" value="{{old('amount')}}"
                                       class="form-control"
                            ...
                            <div class="input-group form-group">
                                ...
                                <input required type="email" name="financier_email" value="{{old('financier_email')}}"
                                       class="form-control" placeholder="أدخل إيميلك ">
                            </div>
                            <!--  رقم للتواصل-->
                            <div class="input-group form-group">
                                <div class="input-group-prepend">
                                ...
                                <input required type="number" name="financier_phone" value="{{old('financier_phone')}}"
                                       class="form-control"
                            ...
                            <div class="input-group form-group ">
                                ...
                                <input name="country" list="mylist" class="form-control" placeholder="اختر الدولة">
                                <datalist id="mylist">
                                    <option value="">
                                        اختر دولة
                                    </option>
                            ...
                            <div class="input-group form-group">
                                ...
                                <input required type="text" value="{{old('financier_address')}}"
                                       name="financier_address" class="form-control" placeholder="أدخل عنوانك كاملاً">
                            </div>
                            <!--زر تأكيد -->
                            <div class=" form-group" style="margin-top:50px;">
                                <div class="row justify-content-center">
                                    <div class="col-xs-7 col-md-4 ">
                                        <button type="submit"
                                                style="background:#c4233d;text-decoration:none;color:white;padding:20px;padding-left:40px;padding-right:40px;border-radius:20px;">
                                            تأكيد
                                        </button>
                                    </div>
                                </div>
