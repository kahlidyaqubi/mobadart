...
@section("title", " تعديل تقييم للمبادرة $initiative->title")
@section("content")
    <div id="app">
        <div class="row">
            <div class="col-md-12">
                <div class="portlet-body">
                    <!-- BEGIN FORM-->
                    <form method="post" action="/admin/evalution/{{$item->id}}" id="form_sample_1"
                            ...
                            <ul class="list-unstyled">
                                <li :key="index" v-for="(evaluate_other,index) in evaluation_others" class="mt-2">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <input v-model="evaluate_other.attribute" name="attributes[]" type="text"
                                                   class="form-control"
                                                   placeholder="أدخل السؤال"/>
                                        </div>
                                        <div class="col-md-3">
                                            <input v-model="evaluate_other.value" name="values[]" type="text"
                                                   class="form-control"
...
@section('js')
    ...
    <script>
        ...
        var app = new Vue({
            el: '#app',
            data: {
                evaluation_others: JSON.parse('{!!$others!!}'),
                active: false,
                errors: [],
                loading: false
            },
