...
@section("title", "تعديل خبر ".$item->title)
@section("content")
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="portlet-body">
                <!-- BEGIN FORM-->
                <form method="post" action="/admin/article/{{$item->id}}" enctype="multipart/form-data"  id="form_sample_1" class="form-horizontal">
                    @method('patch')
                    {{csrf_field()}}
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="title" value="{{$item["title"]}}" data-required="1"
                            ...
                            <div class="col-md-4">
                                <select name="initiative_id" data-required="1"
                                    ...
                                    @foreach($initiatives as $initiative)
                                        <option value="{{$initiative -> id}}" {{$item['initiative_id']==$initiative -> id?"selected":""}}>{{$initiative -> title}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                >
                                <span class="help-block"> تعديل الصورة أمر اختياري </span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                >
                                <span class="help-block"> تعديل الصور أمر اختياري </span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea name="the_file" class="form-control my-editor">{{$item["the_file"]}}</textarea>
                            </div>
                        </div>
                    </div>
