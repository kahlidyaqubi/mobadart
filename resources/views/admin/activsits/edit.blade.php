        ...
        <div class="col-md-12">
            <div class="portlet light bordered" id="form_wizard_1">
                ...
                <div class="portlet-body form">
                    <form method="post" action="/admin/activsit/{{$item->id}}" class="form-horizontal" id="submit_form" >
                        @method('patch')
                        {{csrf_field()}}
                                ...
                                <ul class="nav nav-pills nav-justified steps">
                                    ...
                                    <li>
                                        <a href="#tab3" data-toggle="tab" class="step active">
                                            ...
                                            <span class="desc">
                                                                    <i class="fa fa-check"></i> تعديل اهتمامات </span>
                                        </a>
                                    </li>
                                </ul>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="tab2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" value="{{$item->user["father_name"]}}" name="father_name" required/>
                                                <span class="help-block"> زودنا بالإسم </span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" value="{{$item->user["grand_father_name"]}}" name="grand_father_name"
                                                       required/>
                                                <span class="help-block"> زودنا بالإسم </span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" value="{{$item->user["last_name"]}}" name="last_name" required/>
                                                <span class="help-block"> زودنا بالإسم </span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="number" class="form-control" value="{{$item["ido"]}}" name="ido" required
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="number" class="form-control" value="{{$item["mobile"]}}" name="mobile" minlength="6"
                                                       maxlength="10"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" name="neighborhood" value="{{$item["neighborhood"]}}" required/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="email" class="form-control" value="{{$item->user["email"]}}" name="email" required/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" value="{{$item->user["user_name"]}}" name="user_name"
                                                       pattern="[^\s]+" required/>
                                                ...
                                                <div class="radio-list">
                                                    <label>
                                                        <input type="radio" name="gender" value="M" required
                                                               data-title="Male"  @if($item['gender']) checked @endif />
                                                        ذكر </label>
                                                    <label>
                                                        <input type="radio" name="gender" value="F"
                                                               data-title="Female"  @if(!$item['gender']) checked @endif /> أنثى </label>
                                                </div>
                                    ...
                                    <div class="tab-pane" id="tab3">
                                            ...
                                            <div class="col-md-9">
                                                <select multiple="multiple" class="multi-select" id="my_multi_select1"
                                                    ...
                                                    @foreach($interests as $interest)
                                                        <option value="{{$interest->id}}" @if(in_array($interest->id,$hisinterests))selected @endif>{{$interest->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control input-large" name="other_interests" value="" data-role="tagsinput"> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
