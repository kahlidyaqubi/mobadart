                ...
                <form>
                    <div class="col-sm-4 " style="margin-top: 12px">
                        <input type="text" class="form-control" name="q" value="{{request('q')}}"
                               placeholder="ابحث في اسم المحافظة "/>
                    </div>
                    ...
                    <div class="col-sm-2 " style="margin-top: 12px">
                        <a class="btn btn-success" href="/admin/governorate/create">اضافــة محافظة جديدة</a>
                    </div>
                </form>
            </div>
        </div>
                            ...
                            <td width="25%" class="hidden-xs">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li>
                                            <a href="/admin/governorate/{{$item->id}}/edit">
                                                <span class="text-warning"><i class="icon-pencil"></i> تعديل </span></a>
                                        </li>
                                        <li>
                                            <a href="/admin/governorate/delete/{{$item->id}}" class="Confirm">
                                                <span class="text-danger"><i class="icon-trash"></i> حذف</span></a>
                                        </li>
                                        <li>
                                            <a href="/admin/governorate/cityInGover/{{$item->id}}">
                                                <span class="text-primary"><i
                                                            class="fa fa-sitemap"></i>مدن المحافظة</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
