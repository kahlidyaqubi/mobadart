...
@section("title", "تقرير الناشطين للاهتمامات ")
@section("content")
            ...
            <div class="table-scrollable">
                <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable no-footer">
                    ...
                    @foreach($items as $item)
                        @if($item->activists_count>0)
                        <tr>
                            <td> {{$item->name}}</td>
                            <td> {{$item->activists_count}}</td>
                        </tr>
                        @endif
                    @endforeach
                    </tbody>
...
@section('js')
    ...
    <script>
        ...
        series.dataFields.valueY = "activists_count";
        series.dataFields.categoryX = "name";
        series.name = "activists_count";
