...
@section("title", "إدارة فئات الطلبات")
@section("content")
            ...
            <div class="row">
                <form>
                    ...
                    <div class="col-sm-2 " style="margin-top: 12px">
                        <a class="btn btn-success" href="/admin/categoryDemand/create">اضافــة فئة جديدة</a>
                    </div>
                </form>
            </div>
        </div>
                            ...
                            <td width="25%" class="hidden-xs">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li>
                                            <a href="/admin/categoryDemand/{{$item->id}}/edit">
                                                <span class="text-warning"><i class="icon-pencil"></i> تعديل </span></a>
                                        </li>
                                        <li>
                                            <a href="/admin/categoryDemand/delete/{{$item->id}}" class="Confirm">
                                                <span class="text-danger"><i class="icon-trash"></i> حذف</span></a>
                                        </li>
                                        <li>
                                            <a href="/admin/categoryDemand/demandsInCate/{{$item->id}}" >
                                                <span class="text-primary"><i class="fa fa-sitemap"></i>النماذج من هذه الفئة</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
